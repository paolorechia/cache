...
if [ -n $arg1 ] && [ -a $arg1 ]; then
	...
	echo "$ROOT_DIR/build_time-dat.sh $1 > trab162/plots/assoc-bl.dat"
	$ROOT_DIR/build_time-dat.sh stripped_$1 > $ROOT_DIR/trab162/plots/assoc-bl.dat
	rm stripped_$1
    arquivo=$1-bl.gp
...
set logscale x 2 
DOC0
ylabel="Tempo Medio de Acesso (ns)"
