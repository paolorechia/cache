...
if [ "x$YRANGE" = "x" ] ; then
  YRANGE="[0:0.04]"        ## ELSE usa variavel do ambiente
fi
...
set output "$outFile"
plot \
 "${apl}_A1B32WwAn.dat" us 1:2 tit "wr-thr no-all" w lp lt 1 pt 1 lc rgb "#000000",\
 "${apl}_A1B32WcAw.dat" us 1:2 tit "wr-back alloc" w lp lt 1 pt 9 lc rgb "#ff0000"
EOF0
# echo $outFile
