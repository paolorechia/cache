...
if [ "x$YRANGE" = "x" ] ; then
  YRANGE="[0:0.14]"        ## ELSE usa variavel do ambiente
fi

if [ "x$XRANGE" = "x" ] ; then
  XRANGE="[3:300]"        ## ELSE usa variavel do ambiente
fi
...
set encoding utf8
set title ""  # "$TITLE"
set xlabel "block size [words]"
set ylabel "miss rate"
set lmargin $lmargin # set rmargin $rmargin
set yrange $YRANGE
set logscale x
set xrange $XRANGE
set xtics ("1" 4, "2" 8, "4" 16, "8" 32, "16" 64, "32" 128, "64" 256)
